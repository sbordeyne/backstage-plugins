---
'@sbordeyne/backstage-plugin-kubespec-backend': minor
'@sbordeyne/backstage-plugin-kubespec': minor
'@sbordeyne/kubespec-common': minor
---

Add kubespec: a browsable reference for the Kubernetes API and for the CRDs of the operators you run.
